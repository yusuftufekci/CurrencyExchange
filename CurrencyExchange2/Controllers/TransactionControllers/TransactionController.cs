...
namespace CurrencyExchange2.Controllers.TransactionControllers
{
    public class TransactionController : ControllerBase
    {
        ...
        [HttpPost]
        [Route("BuyCoin")]
        public async Task<ActionResult> BuyCoin([FromBody] BuyCoin BuyCoins, [FromHeader] string token)
        {
            ...
            if (userExist == null)
                return StatusCode(StatusCodes.Status500InternalServerError, new Response { StatusCode = 400, Status = "Error", Message = "User doesnt exist" });
            ...
            {
                return StatusCode(StatusCodes.Status500InternalServerError, new Response { StatusCode = 400, Status = "Error", Message = "You dont have any" + BuyCoins.BuyWİthThisCoin });
            }
